...
1. Veröffentlichung der Anwendung:
...
<CodeBlock language="HTML" title="iframe Beispiel">
  \<iframe src="https://mioto.app/public/BAUMID" width="640" height="640" style="border\:none;">
...
2. Mehr über \<iframe>:
   * Detailliertere Informationen zum \<iframe> findest du hier: [https://www.w3schools.com/tags/tag\_iframe.ASP](https://www.w3schools.com/tags/tag_iframe.ASP "")
