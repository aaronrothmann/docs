...
Zunächst muss bestimmt werden, wo in der Anwendung ein Dokument generiert werden soll. Dort kann ein entsprechender Block vom Typ "Dokument" eingebunden werden. Es sollte sichergestellt werden, dass alle im Dokument verwendeten Variablen aus Nutzereingaben resultieren, die vor Erreichen des Dokumentenblocks von der Anwendung erhoben wurden. Nutzereingaben können durch Eingabeblöcke erhoben werden.
