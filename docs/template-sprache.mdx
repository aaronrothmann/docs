...
Die Referenzierung erfolgt über eine spezielle Template-Sprache - ausgedrückt durch geschweifte Klammern. Wenn ein Dokument generiert wird, läuft unsere Software über das Template, erkennt diese Sprache und ersetzt diese.
...
Die Template-Sprache bietet nicht nur die Möglichkeit, Variablen direkt einzusetzen. Es gibt auch die Möglichkeit, if-Bedingungen zu verwenden. Beispielsweise: Wenn diese Variable vorliegt, füge diesen Absatz ein.
