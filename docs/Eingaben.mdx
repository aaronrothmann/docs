...
Blocktyp "Eingabe" fällt in die Kategorie "Daten", da er mit Variablen arbeitet. Diese Variablen sind Schlüsselelemente in deinem Mioto Builder und dienen dazu, Informationen vom Endnutzer zu erfassen.
...
* Einfachauswahl: Der Endnutzer wählt eine Option aus vordefinierten Antworten.
* Mehrfachauswahl: Der Endnutzer kann mehrere Antworten wählen.
